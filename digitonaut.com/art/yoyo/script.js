...
class App {
  ...
  setup() {
   ...
   // this.stats.showPanel(0);
    ...
    this.animatedMeshes = [];
    this.totalMeshes = 32;
    this.easing = Elastic.easeOut.config(1.5, 0.4);
    this.colorsGradient = {
      firstColor: "#4b08ba",
      secondColor: "#f7ff50",
      steps: 32 };
  ...
  //  this.gui = new dat.GUI();
   ...
   // });
    ...
    //guiGradient.
    //addColor(this.colorsGradient, "firstColor").
    //onChange(color => {
    ...
    //guiGradient.
    //addColor(this.colorsGradient, "secondColor").
    //onChange(color => {
...
/*
    this.stepsController = guiGradient.add(
    this.colorsGradient,
    "steps",
    this.dividers);
...
*/
  ...
  updateColors() {
    ...
    for (let index = 0; index < this.totalMeshes; index++) {
      ...
      index % Math.round(this.totalMeshes / this.colorsGradient.steps) === 0 ?
      colorIndex++ :
      colorIndex;
